...
Upon the release of Alx System Engineering & DevOps project 0x19, approximately 08:07 East African Time (EAT), an outage occurred on an isolated Ubuntu 14.04 container running an Apache web server. GET requests on the server led to 500 Internal Server Error's, when the expected response was an Incorrect HTML file named in the last update.

I encountered the issue upon opening the project and being, well, instructed to address it, roughly 10:20 EAT. I promptly proceeded to undergo solving the problem.
